...
loom {
    ...
    accessWidenerPath = project(":Common").file("src/main/resources/hexctionary.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexctionary-common-Common-refmap.json
        // fixed:   hexctionary-common.refmap.json
