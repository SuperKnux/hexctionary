...
abstract class HexctionaryModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexctionaryModDependenciesExtension>("hexctionaryModDependencies")
