...
loom {
    forge {
        ...
        mixinConfig(
            "hexctionary-common.mixins.json",
            "hexctionary-forge.mixins.json",
        )
    }
    ...
    runs {
        register("commonDatagen") {
            ...
            property("hexctionary.apply-datagen-mixin", "true")
        }
    }
}

hexctionaryModDependencies {
